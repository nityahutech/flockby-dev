...
const ManageMagazines = () => {
  ...
  let fetchMagazineDetails = async () => {
    try {
      let data = await axios.get(`http://127.0.0.1:8000/magazines/`);
        ...
        return (
          <CardDropdown>
            <div className="py-2">
              <Dropdown.Item
                onClick={() =>
                  navigation('/dashboard/add-magazines', {
    ...
    <>
      ...
      <Row className="flex-between-center mb-3">
        <Col xs={4} sm="auto" className="d-flex align-items-center pe-0">
          <h5 className="fs-0 mb-0 text-nowrap py-2 py-xl-0">Magazines</h5>
        </Col>
        <Col xs={8} sm="auto" className="ms-auto text-end ps-0">
          <Link to="/dashboard/add-magazines">
            <IconButton

...
//flockby components
import UserInfoModal from 'data/dashboard/info-modal/user-info-modal';
import FbNavbar from 'components/navbar/top/FbNavbar';
import ManageAdmin from 'data/dashboard/manage-admin';
import ManageMagazines from 'data/dashboard/manage-magazines';
import ManageNgos from 'data/dashboard/manage-ngos';
import ManageCategories from 'data/dashboard/manage-categories';

import AddAdmin from 'data/dashboard/add-admin';
import AddMagazines from 'data/dashboard/add-magazines';
import AddNgos from 'data/dashboard/add-ngos';
import AddCategories from 'data/dashboard/add-categories';

import WildlifeForever from 'data/dashboard/magazines/wildlife-forever';
import WildlifeAddPost from 'data/dashboard/magazines/wildlife-add-post';

import NgosWildlifeForever from 'data/dashboard/ngos/ngo-wildlife-forever';
import NgosAddNewproject from 'data/dashboard/ngos/ngos-add-newproject';
    ...
    <>
      <Routes>
        ...
        <Route element={<MainLayout />}>
          ...
          <Route
            path="info-modal/user-info-modal"
          ...
          <Route
            path="dashboard/manage-magazines"
            element={<ManageMagazines />}
          />
          <Route path="dashboard/add-magazines" element={<AddMagazines />} />
          <Route path="dashboard/manage-ngos" element={<ManageNgos />} />

          <Route path="dashboard/add-ngos" element={<AddNgos />} />
          ...
          {/* Magazines */}
          <Route
            path="magazines/wildlife-forever"
            element={<WildlifeForever />}
          />
          <Route
            path="magazines/wildlife-add-post"
            element={<WildlifeAddPost />}
          />

          {/* NGOs */}
          <Route
            path="ngos/ngo-wildlife-forever"
            element={<NgosWildlifeForever />}
          />
          <Route
            path="ngos/ngos-add-newproject"
            element={<NgosAddNewproject />}
          />
